...
Future<List<BlockedUserStruct>> searchBlockedUsers(
    String search, List<BlockedUserStruct> list) async {
  ...
  final filteredList = list.where((option) {
    return option.fullName.toLowerCase().contains(lowerCaseSearch);
  }).toList();
